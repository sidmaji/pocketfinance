...
import { browserLocalPersistence, browserSessionPersistence, createUserWithEmailAndPassword, GoogleAuthProvider, setPersistence, signInWithPopup } from 'firebase/auth'
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 p-4">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10">
                ...
                <Button type="button" variant="outline" className="w-full flex items-center justify-center gap-3 border-gray-300 hover:bg-gray-50" onClick={handleGoogleSignUp} isLoading={loading}>
                ...
                <div className="mt-8 text-center">
                    <div className="text-sm text-gray-600">
                        ...
                        <a href="/login" className="text-emerald-600 hover:text-emerald-800 font-semibold hover:underline">
                            Sign in
                        </a>
                    </div>
                </div>
